...
>
> **Статус:** проєкт схеми. Бази ще не існує, жодного рядка не створено.
...
- [ ] Вова вирішує: пошта проєкту, приватний репозиторій
- [ ] Створити проєкт Supabase у регіоні London
- [ ] Написати міграцію (migration — файл, що створює таблиці) з цієї схеми
- [ ] Написати правила RLS і **перевірити їх злим тестом**: зайти механіком і
      спробувати дістати комісії
...
*Схема — проєкт. Бази ще не існує. Будь-яка цифра в прикладах — припущення,
не домовленість.*
